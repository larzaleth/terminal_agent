...
3. [Slash Commands](./commands.md) - `/help`, `/model`, `/save`, `/mcp`, and more
...
8. [Cost Tracking](./cost-tracking.md) - Token pricing and usage reports
...
11. [Architecture](./architecture.md) - Codebase tour and design decisions
...
First run prompts for a Gemini API key and saves it to `~/.myagent.env`.
...
- Setup issues: [Getting Started](./getting-started.md) and [Troubleshooting](./troubleshooting.md)
